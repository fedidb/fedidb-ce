		...
		<div class="col-12 col-md-10 offset-md-1">
			...
			<div class="card mb-5">
				<div class="card-header d-flex justify-content-between align-items-center">
					<span class="text-dark font-weight-bold">{{$log->id}}/object.json</span>
					<span>
						<a class="small font-weight-bold text-muted" href="{{$binlog['home']}}/object.json"><i class="far fa-file mr-2"></i>View Raw</a>
					</span>
				</div>
