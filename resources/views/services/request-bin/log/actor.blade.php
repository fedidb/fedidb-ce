		...
		<div class="col-12 col-md-10 offset-md-1">
			...
			<div class="card mb-5">
				<div class="card-header d-flex justify-content-between align-items-center">
					<span class="lead">Actor</span>
					<span>
						<a class="small font-weight-bold text-muted" href="{{$binlog['home']}}/actor.json"><i class="far fa-file mr-2"></i>View Raw</a>
					</span>
				</div>
				<div class="card-body-flush">
					<pre id="payload" class="my-0 py-0 p-3 line-numbers linkable-line-numbers" style="word-break:break-all;white-space: pre-wrap;overflow-y: hidden;min-height: 200px;"><code class="language-json">{{$binlog['object']}}</code></pre>
				</div>
			</div>
		</div>
	</div>
